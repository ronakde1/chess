...
image_size = (37, 37)  # Change this as needed
batch_size = 32
...
model = keras.models.load_model("chess_piece_classifier.h5")

# Compile the model again (if necessary)
model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])

# Evaluate the model on the testing data
steps = test_generator.samples // batch_size  # Calculate the steps
